#!/bin/bash
# =============================================================================
# SETUP DATABASE - Script maestro para configurar la base de datos
# =============================================================================
# Este script configura completamente la base de datos:
# 1. Verifica/instala dependencias
# 2. Verifica/crea estructura de tablas
# 3. Ejecuta todos los seeds en orden
# 4. Crea usuario administrador
#
# Uso:
#   chmod +x setup_database.sh
#   ./setup_database.sh              # Configuración completa
#   ./setup_database.sh --check      # Solo verificar
#   ./setup_database.sh --reset      # Resetear todo (¡PELIGROSO!)
#   ./setup_database.sh --backup     # Crear backup primero
# =============================================================================
